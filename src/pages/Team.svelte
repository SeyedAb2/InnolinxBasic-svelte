          ...
          <div class="column">
                ...
                <div class="team-3">
                  <div class="team-img">
                      ...
                      <img class="team-image-cust" src="{team.src}" alt="Team Image">
                  ...
                  <div class="team-content">
                      <h2>{team.name}</h2>
                      <h3>{team.intro}</h3>
                      <p style="text-align: center ;">{team.text}</p>
                      <h4>{team.email}</h4>
                  </div>
                </div> 
          </div>
...
<section class="container" in:fade>
    ...
    <div class="row">
        <div class="column">
            <div class="team-3">
                <div class="team-img">
                    <img class="team-image-cust" src="image/1.jpeg" alt="Team Image">
                    <div class="team-social">
                        <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
                        <a class="social-fb" href=""><i class="fab fa-facebook-f"></i></a>
                        <a class="social-li" href=""><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="team-content">
                    <h2>مسعود آقایی</h2>
                    <h3>Product Owner</h3>
                    <p>لورم یک ساختار متن ساختگی برای سایت و بلاگ است</p>
                    <h4>info@info.com</h4>
                </div>
            </div>
        </div>
        <div class="column">
            <div class="team-3">
                <div class="team-img">
                    <img class="team-image-cust" src="image/12.jpg" alt="Team Image">
                    <div class="team-social">
                        <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
                        <a class="social-fb" href=""><i class="fab fa-facebook-f"></i></a>
                        <a class="social-li" href=""><i class="fab fa-linkedin-in"></i></a>
        ...
        <div class="column">
            <div class="team-3">
                <div class="team-img">
                    <img class="team-image-cust" src="image/2.jpeg" alt="Team Image">
                    <div class="team-social">
                        <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
                        <a class="social-fb" href=""><i class="fab fa-facebook-f"></i></a>
                        <a class="social-li" href=""><i class="fab fa-linkedin-in"></i></a>
        ...
        <div class="column">
            <div class="team-3">
                <div class="team-img">
                    <img class="team-image-cust" src="image/4.jpeg" alt="Team Image">
                    <div class="team-social">
                        <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
                        <a class="social-fb" href=""><i class="fab fa-facebook-f"></i></a>
                        <a class="social-li" href=""><i class="fab fa-linkedin-in"></i></a>
        ...
        <div class="column">
            <div class="team-3">
                <div class="team-img">
                    <img class="team-image-cust" src="image/13.jpg" alt="Team Image">
                    <div class="team-social">
                        <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
                        <a class="social-fb" href=""><i class="fab fa-facebook-f"></i></a>
                        <a class="social-li" href=""><i class="fab fa-linkedin-in"></i></a>
        ...
        <div class="column">
            <div class="team-3">
                <div class="team-img">
                    <img class="team-image-cust" src="image/517.jpg" alt="Team Image">
                    <div class="team-social">
                        <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
                        <a class="social-fb" href=""><i class="fab fa-facebook-f"></i></a>
                        <a class="social-li" href=""><i class="fab fa-linkedin-in"></i></a>
        ...
        <div class="column">
            <div class="team-3">
                <div class="team-img">
                    <img class="team-image-cust" src="image/6.jpeg" alt="Team Image">
                    <div class="team-social">
                        <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
                        <a class="social-fb" href=""><i class="fab fa-facebook-f"></i></a>
                        <a class="social-li" href=""><i class="fab fa-linkedin-in"></i></a>
        ...
        <div class="column">
            <div class="team-3">
                <div class="team-img">
                    <img class="team-image-cust" src="image/22.jpeg" alt="Team Image">
                    <div class="team-social">
                        <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
                        <a class="social-fb" href=""><i class="fab fa-facebook-f"></i></a>
                        <a class="social-li" href=""><i class="fab fa-linkedin-in"></i></a>
